 ...
 * 
 * It is designed to hold data about a single transaction that a customer has at
 * a Produce Perks location. The class is constructor that parses the data and 
 * getters/setters for the data.
 * 
 * The line below is to help me upkeep this class in case the data changes for
 * Produce Perks in the future.
 * 
...
public class Transaction {
    ...
    private double valueOfCoupons;
    private int countOfCoupons;
    private double cash;
    ...
    public Transaction(String recordLine) {
        ...
        valueOfCoupons = Double.parseDouble(line[INDEX_VALUE_OF_COUPONS_ISSUED]);
        countOfCoupons = Integer.parseInt(line[INDEX_COUNT_OF_COUPONS_ISSUED]);
    ...
    /**
     * @param valueOfCouponsIssued the valueOfCoupons to set
     */
    public void setValueOfCouponsIssued(double valueOfCouponsIssued) {
        this.valueOfCoupons = valueOfCouponsIssued;
    }

    /**
     * @return the countOfCoupons
     */
    public int getCountOfCouponsIssued() {
        return countOfCoupons;
    }

    /**
     * @param countOfCouponsIssued the countOfCoupons to set
     */
    public void setCountOfCouponsIssued(int countOfCouponsIssued) {
        this.countOfCoupons = countOfCouponsIssued;
    }
